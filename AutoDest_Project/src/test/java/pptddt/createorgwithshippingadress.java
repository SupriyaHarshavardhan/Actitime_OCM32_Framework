...
public class createorgwithshippingadress extends BaseClass {
		...
		public void createorgwithShipping() throws Throwable {
			...
			driver.findElement(By.xpath("//textarea[@name='ship_street']")).sendKeys(adddress);
			driver.findElement(By.xpath("//input[@id='ship_pobox']")).sendKeys(adddress1);
			driver.findElement(By.xpath("//input[@id='ship_city']")).sendKeys(adddress2);
			driver.findElement(By.xpath("//input[@id='ship_state']")).sendKeys(adddress3);
			//driver.findElement(By.xpath("//input[@id='ship_code']")).sendKeys(adddress4);
	         driver.findElement(By.xpath("//input[@id='ship_country']")).sendKeys(adddress5);
