...
public class TL_17CreatingOrganizationCopyingBillingAdressSelectOptionIsEnableOrNot_Test  extends BaseClass{
		...
		public void createbillingbutton() throws Throwable {
			...
			boolean shippingradiobutton = createOrgPage.getBillingradiobuttonTF().isEnabled();
