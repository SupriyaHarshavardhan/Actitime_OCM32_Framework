...
public class Tl_20_CreatingOrganizationWithBillingAdress_Test extends BaseClass {
	...
	public void createorgwithbilling() throws Throwable {
		...
		//creating billingadress
					createOrgPage.Creatrbilling(orgName+Jutil.getRandomData(), adddress, adddress1, adddress2, adddress3, adddress5);
